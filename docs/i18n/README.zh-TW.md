...
SERVER_LANG=zh-TW                     # MCP 工具回應語言（完整 locale 見 src/i18n.py）；REST API 改依 Accept-Language
...
- [使用工具的指令](../使用工具的指令.md) — MCP 工具使用指南與最佳實踐
- [Graphiti Memory Rules](../graphiti-memory-rules.md) — 記憶規則說明
