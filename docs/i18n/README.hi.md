...
- **पृष्ठभूमि मेमोरी प्रसंस्करण** — मेमोरी जोड़ना पृष्ठभूमि में निष्पादित हो सकता है, MCP कॉल तुरंत वापस आ जाती है
...
- **Web प्रबंधन इंटरफ़ेस** — अंतर्निहित डैशबोर्ड, ब्राउज़िंग, खोज, ज्ञान ग्राफ विज़ुअलाइज़ेशन, AI प्रश्नोत्तर, समुदाय ब्राउज़िंग
- **बहुभाषी (i18n)** — प्रतिक्रिया संदेश 30+ locale का समर्थन करते हैं (जिनमें zh-TW / en / zh-CN / ja / pt-BR / ko / es / de / fr आदि शामिल हैं); MCP उपकरण `SERVER_LANG` के अनुसार, REST API HTTP `Accept-Language` के अनुसार स्वचालित रूप से वार्ता करता है
...
│   ├── web_api.py                # Web प्रबंधन इंटरफ़ेस REST API (20+ endpoints)
│   ├── ollama_graphiti_client.py  # Ollama LLM क्लाइंट (दोहरा मॉडल वितरण)
│   ├── glm_client.py             # GLM (Zhipu AI) LLM क्लाइंट (OpenAI संगत API)
│   ├── openrouter_client.py      # OpenRouter LLM क्लाइंट (विभिन्न मॉडलों का एकत्रीकरण)
│   ├── deepseek_client.py        # DeepSeek LLM क्लाइंट (json_object + बैकअप json सुरक्षा)
...
- गुणवत्ता विश्लेषण — मेमोरी गुणवत्ता और कवरेज विश्लेषण
...
```bash
# सभी परीक्षण चलाएँ (183, लगभग 1 सेकंड)
