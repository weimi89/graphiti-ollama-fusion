...
- **การประมวลผลหน่วยความจำเบื้องหลัง** — การเพิ่มหน่วยความจำสามารถทำงานในเบื้องหลังได้ การเรียก MCP จะส่งคืนผลทันที
...
- **อินเทอร์เฟซจัดการแบบ Web** — มีแดชบอร์ด การเรียกดู การค้นหา การแสดงผลกราฟความรู้ การถาม-ตอบด้วย AI และการเรียกดูชุมชนในตัว
- **รองรับหลายภาษา (i18n)** — ข้อความตอบกลับรองรับมากกว่า 30 locale (รวมถึง zh-TW / en / zh-CN / ja / pt-BR / ko / es / de / fr ฯลฯ); เครื่องมือ MCP อิงตาม `SERVER_LANG`, REST API เจรจาอัตโนมัติตาม HTTP `Accept-Language`
...
│   ├── web_api.py                # REST API ของอินเทอร์เฟซจัดการแบบ Web (20+ ปลายทาง)
│   ├── ollama_graphiti_client.py  # ไคลเอนต์ LLM Ollama (การแยกงานสองโมเดล)
│   ├── glm_client.py             # ไคลเอนต์ LLM GLM (智谱 AI) (OpenAI compatible API)
│   ├── openrouter_client.py      # ไคลเอนต์ LLM OpenRouter (รวมโมเดลจากหลายค่าย)
│   ├── deepseek_client.py        # ไคลเอนต์ LLM DeepSeek (json_object + การป้องกันสำรอง json)
...
- การวิเคราะห์คุณภาพ — วิเคราะห์คุณภาพและความครอบคลุมของหน่วยความจำ
...
```bash
# รันการทดสอบทั้งหมด (183 รายการ ประมาณ 1 วินาที)
